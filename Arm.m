classdef Arm
    ...
    methods
        ...
        function obj = update(obj)
            ...
            for i = 1:obj.n+1
                obj.x(:,i) = (obj.T(1:3,4,i)) + obj.base;%(POSITION OF LINK1,2,3(x,y,z))
            end
            obj.end_effector = [obj.x(:,obj.n+1); tform2eul(obj.T(:,:,obj.n+1))'];% xyz; raw ptich yaw
        ...
        function plot_arm(obj, axes)
            ...
            COLOR_BROWN = [0.6350 0.0780 0.1840];
            opacity = 0.7;
            ...
            surf(axes, [X;X], [Y;Y], [Z1;Z2], 'FaceColor', COLOR_CYAN, 'EdgeColor', 'none', 'FaceAlpha', opacity)
            fill3(axes, X, Y, Z1, COLOR_CYAN, 'FaceAlpha', opacity);
            fill3(axes, X, Y, Z2, COLOR_CYAN, 'FaceAlpha', opacity);
            ...
            fill3(axes, [X-W2/2*sin(yaw), X+W2/2*sin(yaw), X+L3*cos(yaw)+W2/2*sin(yaw), X+L3*cos(yaw)-W2/2*sin(yaw)], [Y+W2/2*cos(yaw), Y-W2/2*cos(yaw), Y+L3*sin(yaw)-W2/2*cos(yaw), Y+L3*sin(yaw)+W2/2*cos(yaw)], [Z1, Z1, Z1, Z1], COLOR_BROWN, 'FaceAlpha', opacity)
            fill3(axes, [X-W2/2*sin(yaw), X+W2/2*sin(yaw), X+L3*cos(yaw)+W2/2*sin(yaw), X+L3*cos(yaw)-W2/2*sin(yaw)], [Y+W2/2*cos(yaw), Y-W2/2*cos(yaw), Y+L3*sin(yaw)-W2/2*cos(yaw), Y+L3*sin(yaw)+W2/2*cos(yaw)], [Z2, Z2, Z2, Z2], COLOR_BROWN, 'FaceAlpha', opacity)
            fill3(axes, [X+W2/2*sin(yaw), X+W2/2*sin(yaw)+L3*cos(yaw), X+W2/2*sin(yaw)+L3*cos(yaw), X+W2/2*sin(yaw)], [Y-W2/2*cos(yaw), Y+L3*sin(yaw)-W2/2*cos(yaw), Y+L3*sin(yaw)-W2/2*cos(yaw), Y-W2/2*cos(yaw)], [Z1, Z1, Z2, Z2], COLOR_BROWN, 'FaceAlpha', opacity)
            fill3(axes, [X-W2/2*sin(yaw), X-W2/2*sin(yaw)+L3*cos(yaw), X-W2/2*sin(yaw)+L3*cos(yaw), X-W2/2*sin(yaw)], [Y+W2/2*cos(yaw), Y+L3*sin(yaw)+W2/2*cos(yaw), Y+L3*sin(yaw)+W2/2*cos(yaw), Y+W2/2*cos(yaw)], [Z1, Z1, Z2, Z2], COLOR_BROWN, 'FaceAlpha', opacity)
            ...
            surf(axes, [X;X], [Y;Y], [Z1;Z2], 'FaceColor', COLOR_BROWN, 'EdgeColor', 'none', 'FaceAlpha', opacity);
            fill3(axes, X , Y , Z1, COLOR_BROWN, 'FaceAlpha', opacity);
            fill3(axes, X , Y , Z2, COLOR_BROWN, 'FaceAlpha', opacity);
            ...
            y = obj.x(2,4);
            z = obj.x(3,4);
            yaw1 = (tform2eul(obj.T(:,:,obj.n)));
            yaw = yaw1(3);
            h = 0.3;
            w = 0.5;
            plot3(axes, [x-w/2*cos(yaw), x+w/2*cos(yaw)],[y-w/2*sin(yaw), y+w/2*sin(yaw)],[z, z],'linewidth',3,'color',[0.4660 0.6740 0.1880]);
            plot3(axes, [x-w/2*cos(yaw), x-w/2*cos(yaw)],[y-w/2*sin(yaw), y-w/2*sin(yaw)],[z, z-h],'linewidth',3,'color',[0.4660 0.6740 0.1880]);
            plot3(axes, [x+w/2*cos(yaw), x+w/2*cos(yaw)],[y+w/2*sin(yaw), y+w/2*sin(yaw)],[z, z-h],'linewidth',3,'color',[0.4660 0.6740 0.1880]);
        end
        
        function plot_workspace(obj, axes)
            PURPLE_COLOR = [0.4940 0.6 0.1];
